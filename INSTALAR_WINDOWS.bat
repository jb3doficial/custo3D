...
<head>
  ...
  <title>JB3D Cost Studio — Desktop Pro</title>
  ...
  <script>
    (() => {
      ...
      const mobileDevice = matchMedia('(max-width: 860px) and (pointer: coarse)').matches;
      if(mobileDevice && !params.has('desktop')){
        location.replace('./mobile.html' + location.hash);
      }
    })();
  </script>

  <style id="desktop-pro-v2-style">
    @media (min-width:861px){
      ...
      .desktop-pro .app-shell{
        grid-template-columns:var(--sidebar-w) minmax(0,1fr);
        background:#111722;
      }

      .desktop-pro .app-sidebar{
        padding:18px 15px 14px;
        border-right:1px solid #273247;
        background:
          radial-gradient(circle at 16% -2%,rgba(112,94,255,.18),transparent 30%),
          linear-gradient(180deg,#0c1119,#090d14);
      }
      ...
      .desktop-pro .brand-mark{
        width:42px;
        height:42px;
        border-radius:13px;
      }

      .desktop-pro .brand-name{font-size:1rem}

      .desktop-pro .printer-monitor{
        min-height:166px;
        margin:3px 2px 12px;
        border-color:#2b3850;
        background:
          linear-gradient(145deg,rgba(111,92,255,.10),transparent 55%),
          linear-gradient(180deg,#121b29,#0e151f);
      }

      .desktop-pro .sidebar-metrics{
        display:grid;
        grid-template-columns:1fr 1fr;
        gap:7px;
        margin:0 2px 18px;
      ...
      .desktop-pro .sidebar-metric span{
        color:#67758c;
        font-size:.54rem;
        font-weight:800;
        letter-spacing:.055em;
      ...
      .desktop-pro .sidebar-metric strong{
        overflow:hidden;
        color:#dce4ef;
        font-size:.72rem;
      ...
      .desktop-pro .app-workspace{
        grid-template-rows:var(--topbar-h) minmax(0,1fr);
        background:
          linear-gradient(rgba(125,146,180,.025) 1px,transparent 1px),
          linear-gradient(90deg,rgba(125,146,180,.025) 1px,transparent 1px),
          radial-gradient(circle at 100% 0,rgba(50,199,242,.055),transparent 30%),
          #111722;
        background-size:34px 34px,34px 34px,auto,auto;
      }

      .desktop-pro .app-header{
        display:grid;
        grid-template-columns:minmax(230px,1fr) auto minmax(310px,1fr);
        min-height:72px;
        padding:0 25px;
        border-bottom:1px solid #273347;
        background:rgba(15,21,31,.97);
      }

      .desktop-pro .header-live{
        display:flex;
        min-width:225px;
        align-items:center;
        gap:9px;
      ...
      .desktop-pro .header-live strong,
      .desktop-pro .header-live small{display:block}
      ...
      .desktop-pro .header-live small{
        margin-top:2px;
        color:#65738a;
        font-size:.55rem;
      }

      .desktop-pro .header-live-dot{
        width:8px;
        height:8px;
        flex:none;
        border-radius:50%;
        background:#39d99a;
        box-shadow:0 0 0 0 rgba(57,217,154,.38);
        animation:statusPulse 1.8s infinite;
      }

      .desktop-pro .header-actions{justify-content:flex-end}

      .desktop-pro .app-content{
        padding:18px 22px 38px;
      }

      .desktop-pro .desktop-command-center{
        max-width:1540px;
        margin:0 auto 16px;
      }

      .desktop-pro .desktop-kpis{
        display:grid;
        grid-template-columns:repeat(4,minmax(0,1fr));
        gap:11px;
      }

      .desktop-pro .desktop-kpi{
        position:relative;
        display:flex;
        min-width:0;
        min-height:80px;
      ...
      .desktop-pro .desktop-kpi::after{
        ...
        width:82px;
        height:82px;
        border:13px solid rgba(255,255,255,.018);
        border-radius:50%;
      }

      .desktop-pro .desktop-kpi-icon{
        display:grid;
        width:42px;
        height:42px;
        flex:none;
      ...
      .desktop-pro .desktop-kpi-icon.cost{color:#75e2ff;background:rgba(50,199,242,.11)}
      .desktop-pro .desktop-kpi-icon.profit{color:#7ce0b8;background:rgba(57,217,154,.10)}
      .desktop-pro .desktop-kpi-icon.roas{color:#c1b6ff;background:rgba(124,108,255,.12)}
      .desktop-pro .desktop-kpi-icon.products{color:#efd075;background:rgba(247,201,93,.09)}

      .desktop-pro .desktop-kpi small,
      .desktop-pro .desktop-kpi strong{display:block}
      ...
      .desktop-pro .desktop-kpi strong{
        margin-top:7px;
        overflow:hidden;
        color:#edf2f8;
        font-size:1.04rem;
      ...
      .desktop-pro .desktop-commandbar{
        display:flex;
        min-height:57px;
        align-items:center;
        justify-content:space-between;
        ...
        border:1px solid #29364a;
        border-radius:12px;
        background:rgba(18,25,37,.97);
      }

      .desktop-pro .commandbar-info{display:grid;gap:3px}
      .desktop-pro .commandbar-info strong{color:#aab6c7;font-size:.65rem}
      .desktop-pro .commandbar-info span{color:#617086;font-size:.57rem}

      .desktop-pro .commandbar-actions{
        display:flex;
        flex-wrap:wrap;
        gap:7px;
      ...
      .desktop-pro .command-btn.primary{
        border-color:transparent;
        color:white;
        background:linear-gradient(135deg,#7468f7,#576ff0 58%,#31bde6);
      }

      .desktop-pro .tab-panel{
        max-width:1540px;
        margin:0 auto;
      }
      ...
      .desktop-pro #producao .grid,
      .desktop-pro #shopee .grid{
        grid-template-columns:repeat(3,minmax(0,1fr));
      }

      .desktop-pro #producao .field.full,
      .desktop-pro #shopee .field.full{grid-column:1/-1}
      ...
      .desktop-pro .card-inner{padding:20px}
      .desktop-pro .card-title{margin-bottom:18px;padding-bottom:14px}
      .desktop-pro .card-title h2,
      .desktop-pro .card-title h3{font-size:.96rem}

      .desktop-pro .input-wrap{
        min-height:50px;
        border-color:#2d3b50;
        background:#0f1621;
      }
      ...
      .desktop-pro input,
      .desktop-pro select{font-size:.84rem}

      .desktop-pro details[open] .advanced .grid{
        grid-template-columns:repeat(3,minmax(0,1fr));
      }

      .desktop-pro .result-card{
        top:0;
      ...
      .desktop-pro .result-top{padding:24px 22px 21px}
      .desktop-pro .big-value{font-size:3.25rem}
      .desktop-pro .breakdown{padding:8px 19px 18px}
      .desktop-pro .row{padding:10px 2px;font-size:.71rem}

      .desktop-pro .roas-layout{
        grid-template-columns:250px minmax(0,1fr);
      }

      .desktop-pro #produtos .card{min-height:560px}
      .desktop-pro #produtos .products-toolbar{
        grid-template-columns:minmax(420px,1fr) auto;
      }

      .desktop-pro #produtos .saved-products{
        display:grid;
        grid-template-columns:repeat(2,minmax(0,1fr));
        gap:10px;
      }

      .desktop-pro #produtos .product-item{
        min-height:92px;
        padding:14px;
      }

      .desktop-pro .sync-layout{
        grid-template-columns:minmax(540px,1.05fr) minmax(460px,.95fr);
        max-width:none;
      }

      .desktop-pro .sync-qr-stage{min-height:420px}

      .desktop-pro .sync-scanner-shell,
      .desktop-pro .sync-scanner,
      .desktop-pro .sync-scanner video,
      .desktop-pro .sync-scanner-fallback{min-height:350px}

      .desktop-pro .sync-status-card{max-width:none}
    }

    @media (min-width:861px) and (max-width:1280px){
      body.desktop-pro{--sidebar-w:242px}
      .desktop-pro .desktop-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}
      .desktop-pro .header-live{display:none}
      .desktop-pro .app-header{grid-template-columns:minmax(220px,1fr) auto}
      .desktop-pro .layout{grid-template-columns:minmax(550px,1fr) 350px}
      ...
      .desktop-pro #produtos .saved-products{grid-template-columns:1fr}
      .desktop-pro .sync-layout{grid-template-columns:1fr}
    }
  </style>

</head>
<body class="desktop-pro">
  <div class="app-shell">
    <aside class="app-sidebar">
      ...
      <div class="sidebar-metrics">
        <div class="sidebar-metric">
          ...
          <strong id="sideFilamentValue">R$ 0,00</strong>
        </div>
        <div class="sidebar-metric">
          <span>Energia/kWh</span>
          <strong id="sideEnergyValue">R$ 0,00</strong>
        </div>
        <div class="sidebar-metric">
          <span>ROAS ativo</span>
          <strong id="sideRoasValue">6,00x</strong>
        </div>
        <div class="sidebar-metric">
          <span>Produtos</span>
          <strong id="sideProductCount">0</strong>
        </div>
      </div>
    ...
    <section class="app-workspace">
      <header class="app-header">
        ...
        <div class="header-live">
          ...
          <div>
            <strong>Cálculo em tempo real</strong>
            <small>Salvamento automático ativo</small>
          </div>
        </div>
      ...
      <main class="app-content">
        <section class="desktop-command-center">
          <div class="desktop-kpis">
            <article class="desktop-kpi">
              <span class="desktop-kpi-icon cost">◫</span>
              <div><small>Custo por unidade</small><strong id="desktopUnitCost">R$ 0,00</strong></div>
            </article>
            <article class="desktop-kpi">
              <span class="desktop-kpi-icon profit">↗</span>
              <div><small>Lucro líquido</small><strong id="desktopProfit">R$ 0,00</strong></div>
            </article>
            <article class="desktop-kpi">
              <span class="desktop-kpi-icon roas">×</span>
              <div><small>ROAS configurado</small><strong id="desktopRoas">6,00x</strong></div>
            </article>
            <article class="desktop-kpi">
              <span class="desktop-kpi-icon products">▦</span>
              <div><small>Produtos salvos</small><strong id="desktopProducts">0</strong></div>
            </article>
          </div>
          ...
          <div class="desktop-commandbar">
            <div class="commandbar-info">
              ...
              <span>Atalhos: Ctrl+1 Produção · Ctrl+2 Shopee · Ctrl+3 Produtos · Ctrl+4 Sincronização</span>
            </div>
            <div class="commandbar-actions">
              <button class="command-btn primary" id="desktopNewCalculation" type="button">＋ Novo cálculo</button>
              <button class="command-btn" data-desktop-tab="shopee" type="button">▣ Precificar</button>
              <button class="command-btn" data-desktop-tab="produtos" type="button">▦ Produtos</button>
              <button class="command-btn" data-desktop-tab="sync" type="button">⌁ Sincronizar</button>
            </div>
          </div>
        </section>
            ...
            <div class="card-inner">
              <div class="card-title">
                <div>
                  ...
                  <div class="hint">Informe apenas os dados variáveis do lote atual.</div>
                </div>
            ...
            <div class="card-inner">
              <div class="card-title">
                <div>
                  ...
                  <div class="hint">Simule taxas, ROAS, preço e margem antes de anunciar.</div>
                </div>
  ...
  <script>
    ...
    function calculateProduction(){
      ...
      if($('desktopUnitCost')) setText('desktopUnitCost',money.format(unit));
      if($('sideFilamentValue')) setText('sideFilamentValue',money.format(kgPrice));
      if($('sideEnergyValue')) setText('sideEnergyValue',money.format(energyRate));
    ...
    function calculateShopee(){
      ...
      if($('desktopProfit')) setText('desktopProfit',money.format(profit));
      if($('desktopRoas')) setText('desktopRoas',roas > 0 ? `${numberBR.format(roas)}x` : 'Inválido');
      if($('sideRoasValue')) setText('sideRoasValue',roas > 0 ? `${numberBR.format(roas)}x` : '—');
    ...
    function renderSavedProducts(){
      ...
      if($('desktopProducts')) setText('desktopProducts',String(total));
      if($('sideProductCount')) setText('sideProductCount',String(total));
    ...
    document.querySelectorAll('[data-desktop-tab]').forEach(button => {
      button.addEventListener('click',() => showTab(button.dataset.desktopTab));
    });

    $('desktopNewCalculation').addEventListener('click',() => {
      showTab('producao');
      $('resetProduction').click();
      setTimeout(() => $('filamentGrams').focus(),120);
    });

    window.addEventListener('keydown',(event) => {
      if(!event.ctrlKey || event.altKey || event.metaKey) return;
      const shortcuts = {'1':'producao','2':'shopee','3':'produtos','4':'sync'};
